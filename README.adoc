...
http://localhost:3000/acc-new-app-dev-m3/main/1-introduction.html?USERID=user1&SUBDOMAIN=cluster-8s5ss.sandbox701.opentlc.com&TOMCATIP=150.240.99.53
...
[source,bash]
----
oc new-app  https://github.com/juliaaano/acc-new-app-dev-m3.git --strategy=docker

oc create route edge acc-new-app-dev-m3 --service=acc-new-app-dev-m3
----
